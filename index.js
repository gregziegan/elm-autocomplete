...
var _thebritican$elm_autocomplete$Autocomplete_Autocomplete$viewData = F3(
	function (_p17, _p16, data) {
		var _p18 = _p17;
		var _p19 = _p16;
		var id = _p18.toId(data);
		var isSelected = function (maybeId) {
			var _p20 = maybeId;
			if (_p20.ctor === 'Just') {
				return _elm_lang$core$Native_Utils.eq(_p20._0, id);
			} else {
				return false;
			}
		};
		var listItemData = A3(
			_p18.li,
			isSelected(_p19.key),
			isSelected(_p19.mouse),
			data);
		var customAttributes = A2(_elm_lang$core$List$map, _thebritican$elm_autocomplete$Autocomplete_Autocomplete$trickyMap, listItemData.attributes);
		var customLiAttr = A2(
			_elm_lang$core$List$append,
			customAttributes,
			_elm_lang$core$Native_List.fromArray(
...
var _thebritican$elm_autocomplete$Autocomplete_Autocomplete$viewSection = F3(
	function (config, state, section) {
		...
		var viewItemList = A2(
			...
			A2(_elm_lang$core$List$map, _thebritican$elm_autocomplete$Autocomplete_Autocomplete$trickyMap, config.ul),
			A2(
				_elm_lang$core$List$map,
				getKeyedItems,
				config.section.getData(section)));
		var sectionNode = config.section.li(section);
		var attributes = A2(_elm_lang$core$List$map, _thebritican$elm_autocomplete$Autocomplete_Autocomplete$trickyMap, sectionNode.attributes);
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					A3(_elm_lang$html$Html$node, sectionNode.nodeType, attributes, children)
				]));
	});
var _thebritican$elm_autocomplete$Autocomplete_Autocomplete$viewWithSections = F4(
	function (config, howManyToShow, state, sections) {
		...
		return A2(
			_elm_lang$html$Html_Keyed$ul,
			A2(_elm_lang$core$List$map, _thebritican$elm_autocomplete$Autocomplete_Autocomplete$trickyMap, config.section.ul),
			A2(_elm_lang$core$List$map, getKeyedItems, sections));
	});
var _thebritican$elm_autocomplete$Autocomplete_Autocomplete$viewItem = F3(
	function (_p22, _p21, data) {
		var _p23 = _p22;
		var _p24 = _p21;
		var id = _p23.toId(data);
		var isSelected = function (maybeId) {
			var _p25 = maybeId;
			if (_p25.ctor === 'Just') {
				return _elm_lang$core$Native_Utils.eq(_p25._0, id);
			} else {
				return false;
			}
		};
...
var _thebritican$elm_autocomplete$Autocomplete_Autocomplete$viewList = F4(
	function (config, howManyToShow, state, data) {
		...
		var customUlAttr = A2(_elm_lang$core$List$map, _thebritican$elm_autocomplete$Autocomplete_Autocomplete$trickyMap, config.ul);
		return A2(
			_elm_lang$html$Html_Keyed$ul,
			customUlAttr,
			A2(
		...
		while (true) {
			...
			switch (_p26.ctor) {
				case 'KeyDown':
					...
					var newKey = A3(_thebritican$elm_autocomplete$Autocomplete_Autocomplete$navigateWithKey, _p27, boundedList, state.key);
							...
							if (config.separateSelections) {
								return {
									...
									_0: _elm_lang$core$Native_Utils.update(
										state,
										{key: newKey}),
									_1: A2(config.onKeyDown, _p27, newKey)
								};
							} else {
								return {
									ctor: '_Tuple2',
				...
				case 'MouseEnter':
					...
					return {
						ctor: '_Tuple2',
						_0: A3(_thebritican$elm_autocomplete$Autocomplete_Autocomplete$resetMouseStateWithId, config.separateSelections, _p28, state),
						_1: config.onMouseEnter(_p28)
					};
				case 'MouseLeave':
					var _p29 = _p26._0;
					return {
...
var _thebritican$elm_autocomplete$AccessibleExample$customizedLi = F3(
		...
		return keySelected ? {
			attributes: _elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$html$Html_Attributes$id(person.name)
				]),
...
var _thebritican$elm_autocomplete$AccessibleExample$viewConfig = _thebritican$elm_autocomplete$Autocomplete$viewConfig(
	{
		toId: function (_) {
			return _.name;
		},
		ul: _elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('autocomplete-list')
			]),
		li: _thebritican$elm_autocomplete$AccessibleExample$customizedLi
	});
var _thebritican$elm_autocomplete$AccessibleExample$acceptablePeople = F2(
...
var _thebritican$elm_autocomplete$AccessibleExample$resetMenu = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{autoState: _thebritican$elm_autocomplete$Autocomplete$empty, showMenu: false});
};
var _thebritican$elm_autocomplete$AccessibleExample$removeSelection = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{selectedPerson: _elm_lang$core$Maybe$Nothing});
};
var _thebritican$elm_autocomplete$AccessibleExample$resetInput = function (model) {
	return _thebritican$elm_autocomplete$AccessibleExample$resetMenu(
		_thebritican$elm_autocomplete$AccessibleExample$removeSelection(
			_elm_lang$core$Native_Utils.update(
				model,
				{query: ''})));
};
var _thebritican$elm_autocomplete$AccessibleExample$Model = F6(
	function (a, b, c, d, e, f) {
		return {people: a, autoState: b, howManyToShow: c, query: d, selectedPerson: e, showMenu: f};
	});
var _thebritican$elm_autocomplete$AccessibleExample$Person = F4(
	function (a, b, c, d) {
		return {name: a, year: b, city: c, state: d};
	});
var _thebritican$elm_autocomplete$AccessibleExample$getPersonAtId = F2(
	function (people, id) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			A4(_thebritican$elm_autocomplete$AccessibleExample$Person, '', 0, '', ''),
...
var _thebritican$elm_autocomplete$AccessibleExample$setQuery = F2(
	function (model, id) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				query: function (_) {
					...
					A2(_thebritican$elm_autocomplete$AccessibleExample$getPersonAtId, model.people, id)),
				selectedPerson: _elm_lang$core$Maybe$Just(
					A2(_thebritican$elm_autocomplete$AccessibleExample$getPersonAtId, model.people, id))
			});
	});
var _thebritican$elm_autocomplete$AccessibleExample$presidents = _elm_lang$core$Native_List.fromArray(
	[
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'George Washington', 1732, 'Westmoreland County', 'Virginia'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'John Adams', 1735, 'Braintree', 'Massachusetts'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Thomas Jefferson', 1743, 'Shadwell', 'Virginia'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'James Madison', 1751, 'Port Conway', 'Virginia'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'James Monroe', 1758, 'Monroe Hall', 'Virginia'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Andrew Jackson', 1767, 'Waxhaws Region', 'South/North Carolina'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'John Quincy Adams', 1767, 'Braintree', 'Massachusetts'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'William Henry Harrison', 1773, 'Charles City County', 'Virginia'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Martin Van Buren', 1782, 'Kinderhook', 'New York'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Zachary Taylor', 1784, 'Barboursville', 'Virginia'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'John Tyler', 1790, 'Charles City County', 'Virginia'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'James Buchanan', 1791, 'Cove Gap', 'Pennsylvania'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'James K. Polk', 1795, 'Pineville', 'North Carolina'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Millard Fillmore', 1800, 'Summerhill', 'New York'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Franklin Pierce', 1804, 'Hillsborough', 'New Hampshire'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Andrew Johnson', 1808, 'Raleigh', 'North Carolina'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Abraham Lincoln', 1809, 'Sinking spring', 'Kentucky'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Ulysses S. Grant', 1822, 'Point Pleasant', 'Ohio'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Rutherford B. Hayes', 1822, 'Delaware', 'Ohio'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Chester A. Arthur', 1829, 'Fairfield', 'Vermont'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'James A. Garfield', 1831, 'Moreland Hills', 'Ohio'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Benjamin Harrison', 1833, 'North Bend', 'Ohio'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Grover Cleveland', 1837, 'Caldwell', 'New Jersey'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'William McKinley', 1843, 'Niles', 'Ohio'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Woodrow Wilson', 1856, 'Staunton', 'Virginia'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'William Howard Taft', 1857, 'Cincinnati', 'Ohio'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Theodore Roosevelt', 1858, 'New York City', 'New York'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Warren G. Harding', 1865, 'Blooming Grove', 'Ohio'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Calvin Coolidge', 1872, 'Plymouth', 'Vermont'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Herbert Hoover', 1874, 'West Branch', 'Iowa'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Franklin D. Roosevelt', 1882, 'Hyde Park', 'New York'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Harry S. Truman', 1884, 'Lamar', 'Missouri'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Dwight D. Eisenhower', 1890, 'Denison', 'Texas'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Lyndon B. Johnson', 1908, 'Stonewall', 'Texas'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Ronald Reagan', 1911, 'Tampico', 'Illinois'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Richard M. Nixon', 1913, 'Yorba Linda', 'California'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Gerald R. Ford', 1913, 'Omaha', 'Nebraska'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'John F. Kennedy', 1917, 'Brookline', 'Massachusetts'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'George H. W. Bush', 1924, 'Milton', 'Massachusetts'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Jimmy Carter', 1924, 'Plains', 'Georgia'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'George W. Bush', 1946, 'New Haven', 'Connecticut'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Bill Clinton', 1946, 'Hope', 'Arkansas'),
		A4(_thebritican$elm_autocomplete$AccessibleExample$Person, 'Barack Obama', 1961, 'Honolulu', 'Hawaii')
	]);
...
var _thebritican$elm_autocomplete$AccessibleExample$SelectPersonMouse = function (a) {
	return {ctor: 'SelectPersonMouse', _0: a};
};
var _thebritican$elm_autocomplete$AccessibleExample$SelectPersonKeyboard = function (a) {
	return {ctor: 'SelectPersonKeyboard', _0: a};
};
var _thebritican$elm_autocomplete$AccessibleExample$HandleEscape = {ctor: 'HandleEscape'};
var _thebritican$elm_autocomplete$AccessibleExample$Reset = {ctor: 'Reset'};
var _thebritican$elm_autocomplete$AccessibleExample$Wrap = function (a) {
	return {ctor: 'Wrap', _0: a};
};
var _thebritican$elm_autocomplete$AccessibleExample$updateConfig = _thebritican$elm_autocomplete$Autocomplete$updateConfig(
	{
		toId: function (_) {
			return _.name;
		},
		onKeyDown: F2(
			function (code, maybeId) {
				return (_elm_lang$core$Native_Utils.eq(code, 38) || _elm_lang$core$Native_Utils.eq(code, 40)) ? A2(_elm_lang$core$Maybe$map, _thebritican$elm_autocomplete$AccessibleExample$PreviewPerson, maybeId) : (_elm_lang$core$Native_Utils.eq(code, 13) ? A2(_elm_lang$core$Maybe$map, _thebritican$elm_autocomplete$AccessibleExample$SelectPersonKeyboard, maybeId) : _elm_lang$core$Maybe$Just(_thebritican$elm_autocomplete$AccessibleExample$Reset));
			}),
		onTooLow: _elm_lang$core$Maybe$Just(
			_thebritican$elm_autocomplete$AccessibleExample$Wrap(false)),
		onTooHigh: _elm_lang$core$Maybe$Just(
			_thebritican$elm_autocomplete$AccessibleExample$Wrap(true)),
		onMouseEnter: function (id) {
			return _elm_lang$core$Maybe$Just(
				_thebritican$elm_autocomplete$AccessibleExample$PreviewPerson(id));
		},
		...
		onMouseClick: function (id) {
			return _elm_lang$core$Maybe$Just(
				_thebritican$elm_autocomplete$AccessibleExample$SelectPersonMouse(id));
		},
		separateSelections: false
	});
var _thebritican$elm_autocomplete$AccessibleExample$update = F2(
	function (msg, model) {
		update:
		while (true) {
			...
			switch (_p2.ctor) {
				case 'SetQuery':
					...
					var showMenu = function (_p3) {
						...
						A2(_thebritican$elm_autocomplete$AccessibleExample$acceptablePeople, _p4, model.people));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
				...
				case 'HandleEscape':
					var validOptions = _elm_lang$core$Basics$not(
						_elm_lang$core$List$isEmpty(
							A2(_thebritican$elm_autocomplete$AccessibleExample$acceptablePeople, model.query, model.people)));
					var handleEscape = validOptions ? _thebritican$elm_autocomplete$AccessibleExample$resetMenu(
						_thebritican$elm_autocomplete$AccessibleExample$removeSelection(model)) : _thebritican$elm_autocomplete$AccessibleExample$resetMenu(
						_thebritican$elm_autocomplete$AccessibleExample$removeSelection(
							_elm_lang$core$Native_Utils.update(
								model,
								{query: ''})));
					var escapedModel = function () {
						...
						if (_p7.ctor === 'Just') {
							return _elm_lang$core$Native_Utils.eq(model.query, _p7._0.name) ? _thebritican$elm_autocomplete$AccessibleExample$resetInput(model) : handleEscape;
						} else {
							return handleEscape;
						}
					}();
				...
				case 'Wrap':
					...
					if (_p8.ctor === 'Just') {
						var _v6 = _thebritican$elm_autocomplete$AccessibleExample$Reset,
							_v7 = model;
						msg = _v6;
						model = _v7;
						continue update;
				...
				case 'Reset':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								autoState: A2(_thebritican$elm_autocomplete$Autocomplete$reset, _thebritican$elm_autocomplete$AccessibleExample$updateConfig, model.autoState),
								selectedPerson: _elm_lang$core$Maybe$Nothing
							}),
						_elm_lang$core$Native_List.fromArray(
							[]));
				case 'SelectPersonKeyboard':
					var newModel = _thebritican$elm_autocomplete$AccessibleExample$resetMenu(
						A2(_thebritican$elm_autocomplete$AccessibleExample$setQuery, model, _p2._0));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						newModel,
						_elm_lang$core$Native_List.fromArray(
				...
				case 'SelectPersonMouse':
					...
					return {
						...
						_1: A3(
							...
							function (err) {
								return _thebritican$elm_autocomplete$AccessibleExample$NoOp;
							},
							function (_p9) {
								return _thebritican$elm_autocomplete$AccessibleExample$NoOp;
							},
				...
				case 'PreviewPerson':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								selectedPerson: _elm_lang$core$Maybe$Just(
									A2(_thebritican$elm_autocomplete$AccessibleExample$getPersonAtId, model.people, _p2._0))
							}),
						_elm_lang$core$Native_List.fromArray(
							[]));
				case 'OnFocus':
...
var _thebritican$elm_autocomplete$AccessibleExample$SetAutoState = function (a) {
	return {ctor: 'SetAutoState', _0: a};
};
var _thebritican$elm_autocomplete$AccessibleExample$subscriptions = function (model) {
	return A2(_elm_lang$core$Platform_Sub$map, _thebritican$elm_autocomplete$AccessibleExample$SetAutoState, _thebritican$elm_autocomplete$Autocomplete$subscription);
};
var _thebritican$elm_autocomplete$AccessibleExample$viewMenu = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_elm_lang$html$Html_App$map,
				_thebritican$elm_autocomplete$AccessibleExample$SetAutoState,
				A4(
					_thebritican$elm_autocomplete$Autocomplete$view,
					_thebritican$elm_autocomplete$AccessibleExample$viewConfig,
					model.howManyToShow,
					model.autoState,
					A2(_thebritican$elm_autocomplete$AccessibleExample$acceptablePeople, model.query, model.people)))
			]));
};
var _thebritican$elm_autocomplete$AccessibleExample$SetQuery = function (a) {
	return {ctor: 'SetQuery', _0: a};
};
var _thebritican$elm_autocomplete$AccessibleExample$view = function (model) {
	var activeDescendant = function (attributes) {
		var _p10 = model.selectedPerson;
		if (_p10.ctor === 'Just') {
			return A2(
				_elm_lang$core$List_ops['::'],
				A2(_elm_lang$html$Html_Attributes$attribute, 'aria-activedescendant', _p10._0.name),
				attributes);
		} else {
			return attributes;
		}
	...
	var menu = model.showMenu ? _elm_lang$core$Native_List.fromArray(
		[
			_thebritican$elm_autocomplete$AccessibleExample$viewMenu(model)
		]) : _elm_lang$core$Native_List.fromArray(
		[]);
	var dec = A2(
		...
		function (code) {
			return (_elm_lang$core$Native_Utils.eq(code, 38) || _elm_lang$core$Native_Utils.eq(code, 40)) ? _elm_lang$core$Result$Ok(_thebritican$elm_autocomplete$AccessibleExample$NoOp) : (_elm_lang$core$Native_Utils.eq(code, 27) ? _elm_lang$core$Result$Ok(_thebritican$elm_autocomplete$AccessibleExample$HandleEscape) : _elm_lang$core$Result$Err('not handling that key'));
		});
					...
					activeDescendant(
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$String$toLower(
									_elm_lang$core$Basics$toString(model.showMenu))),
								A2(_elm_lang$html$Html_Attributes$attribute, 'role', 'combobox'),
								A2(_elm_lang$html$Html_Attributes$attribute, 'aria-autocomplete', 'list')
							])),
					_elm_lang$core$Native_List.fromArray(
						[]))
				]),
...
var _thebritican$elm_autocomplete$AccessibleExample$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				_thebritican$elm_autocomplete$AccessibleExample$init,
				_elm_lang$core$Native_List.fromArray(
					[])),
...
var _thebritican$elm_autocomplete$Main$viewLogo = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('green-part')
				]),
			_elm_lang$core$Native_List.fromArray(
				[])),
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('yellow triangle')
				]),
			_elm_lang$core$Native_List.fromArray(
				[])),
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('gray triangle')
				]),
			_elm_lang$core$Native_List.fromArray(
				[])),
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('blue triangle')
				]),
			_elm_lang$core$Native_List.fromArray(
				[]))
		]));
var _thebritican$elm_autocomplete$Main$viewHeader = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Elm Autocomplete')
					])),
				_thebritican$elm_autocomplete$Main$viewLogo,
				A2(
				_elm_lang$html$Html$p,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('header-description')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
...
var _thebritican$elm_autocomplete$Main$viewForkMe = A2(
	_elm_lang$html$Html$a,
	_elm_lang$core$Native_List.fromArray(
		[
			A2(_elm_lang$html$Html_Attributes$attribute, 'aria-label', 'View source on Github'),
			_elm_lang$html$Html_Attributes$class('github-corner'),
			_elm_lang$html$Html_Attributes$href('https://github.com/thebritican/elm-autocomplete')
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$svg$Svg_Attributes$style('fill:#70B7FD; color:#fff; position: absolute; top: 0; border: 0; right: 0;'),
					_elm_lang$svg$Svg_Attributes$viewBox('0 0 250 250'),
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$svg$Svg_Attributes$d('M0,0 L115,115 L130,115 L142,142 L250,250 L250,0 Z')
						]),
					_elm_lang$core$Native_List.fromArray(
						[])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$svg$Svg_Attributes$class('octo-arm'),
							_elm_lang$svg$Svg_Attributes$d('M128.3,109.0 C113.8,99.7 119.0,89.6 119.0,89.6 C122.0,82.7 120.5,78.6 120.5,78.6 C119.2,72.0 123.4,76.3 123.4,76.3 C127.3,80.9 125.5,87.3 125.5,87.3 C122.9,97.6 130.6,101.9 134.4,103.2'),
							_elm_lang$svg$Svg_Attributes$fill('currentColor'),
							_elm_lang$svg$Svg_Attributes$style('transform-origin: 130px 106px;')
						]),
					_elm_lang$core$Native_List.fromArray(
						[])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$svg$Svg_Attributes$class('octo-body'),
							_elm_lang$svg$Svg_Attributes$d('M115.0,115.0 C114.9,115.1 118.7,116.5 119.8,115.4 L133.7,101.6 C136.9,99.2 139.9,98.4 142.2,98.6 C133.8,88.0 127.5,74.4 143.8,58.0 C148.5,53.4 154.0,51.2 159.7,51.0 C160.3,49.4 163.2,43.6 171.4,40.1 C171.4,40.1 176.1,42.5 178.8,56.2 C183.1,58.6 187.2,61.8 190.9,65.4 C194.5,69.0 197.7,73.2 200.1,77.6 C213.8,80.2 216.3,84.9 216.3,84.9 C212.7,93.1 206.9,96.0 205.4,96.6 C205.1,102.4 203.0,107.8 198.3,112.5 C181.9,128.9 168.3,122.5 157.7,114.1 C157.9,116.9 156.7,120.9 152.7,124.9 L141.0,136.5 C139.8,137.7 141.6,141.9 141.8,141.8 Z'),
							_elm_lang$svg$Svg_Attributes$fill('currentColor')
						]),
					_elm_lang$core$Native_List.fromArray(
						[]))
...
var _thebritican$elm_autocomplete$Main$viewElmLink = A2(
	_elm_lang$html$Html$a,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$href('http://elm-lang.org/'),
			_elm_lang$html$Html_Attributes$value('_blank'),
			_elm_lang$html$Html_Attributes$class('elm-link')
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('elm-link-image'),
					_elm_lang$html$Html_Attributes$src('http://elm-lang.org/assets/logo.svg')
				]),
			_elm_lang$core$Native_List.fromArray(
				[]))
		]));
...
var _thebritican$elm_autocomplete$Main$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_thebritican$elm_autocomplete$Main$viewElmLink,
				_thebritican$elm_autocomplete$Main$viewForkMe,
				_thebritican$elm_autocomplete$Main$viewApp(model)
			]));
};
var _thebritican$elm_autocomplete$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				_thebritican$elm_autocomplete$Main$init,
				_elm_lang$core$Native_List.fromArray(
					[])),
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _thebritican$elm_autocomplete$Main$main === 'undefined' ? null : _thebritican$elm_autocomplete$Main$main);
